		...
		<div class="container">
			<div class="row">
				...
				<article class="col-md-3">
					<section class="place_order_sidebar vert_tab">
						<ul class="nav nav-tabs"><!-- 'tabs-right' for right tabs -->
						    <li class="active"><a href="#plc_crn_home" data-toggle="tab">Home</a></li>
						    <li><a href="#plc_crn_buk_ordr" data-toggle="tab">Book Order</a></li>
						    <li><a href="#plc_crn_updt_info" data-toggle="tab">Update Info</a></li>
						    <li><a href="#plc_crn_statns" data-toggle="tab">Select Station</a></li>
						    <li><a href="#plc_crn_subcrb_packg" data-toggle="tab">Subscription & Package</a></li>
					...
					<section class="place_order_main order_outr">
						<div class="tab-content">
				    			...
				    			<div class="order_wrpr">
					    			...
					    			<div class="row">
					    				<article class="col-sm-12">
					    					<input type="button" name="cancel_order" id="cancel_butn" value="Cancel">

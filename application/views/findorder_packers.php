		    					...
		    					<div class="row">
				    				<article class="col-md-12">
				    					<div class="section_head">
											<h1>Find Order for <span>Packers &amp; Movers</span></h1>
										</div>
				    				</article>
				    			</div>
				    			<div class="row">
				    								...
				    								<div class="row">
														<article class="col-md-6">
															<div class="form-group">
															    ...
															    <select name="" id="from_station" class="form-control">
														...
														<article class="col-md-6">
															<div class="form-group">
															    ...
															    <select name="" id="to_station" class="form-control">
															    	<option>Rajajinagar</option>
															    	<option>Rajajinagar</option>
															    	<option>Rajajinagar</option>
															    	<option>Rajajinagar</option>
													...
													<div class="row">
														<article class="col-md-6">
															<div class="form-group">
															    ...
															    <select name="" id="service_for" class="form-control">
